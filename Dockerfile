...
ARG ERD_GOLANG_BUILDER_TAG=1.26-alpine3.23
ARG A2S_GOLANG_BUILDER_TAG=1.26-alpine3.23
...
ARG asciidoctor_pdf_version=2.3.24
...
ARG asciidoctor_diagram_version=3.2.1
ARG asciidoctor_defmastership_version=1.3.5
ARG defmastership_version=1.3.6
...
ARG asciidoctor_kroki_version=0.10.2
